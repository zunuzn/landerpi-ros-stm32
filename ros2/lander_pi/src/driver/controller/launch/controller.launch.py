...
def launch_setup(context):
    ...
    enable_encoder_odom = LaunchConfiguration('enable_encoder_odom', default='false')
    ...
    enable_encoder_odom_arg = DeclareLaunchArgument('enable_encoder_odom', default_value=enable_encoder_odom)
    ...
    encoder_odom_node = Node(
        ...
        condition=IfCondition(enable_encoder_odom),
    )
